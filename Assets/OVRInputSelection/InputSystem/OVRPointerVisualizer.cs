    ...
    public class OVRPointerVisualizer : MonoBehaviour {
        ...
        public void SetPointer(Ray ray) {
            if (linePointer != null) {
				...
				rayDrawDistance = Vector3.Distance (targetCanvas.transform.position, ray.origin);
				//Debug.Log (rayDrawDistance); 
				linePointer.position = ray.origin + ray.direction * rayDrawDistance;
